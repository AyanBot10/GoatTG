...
const { commands, aliases } = global.YukiBot;
const doNotDelete = "[ 😉 | Yuki Bot V2 ]";
/**
* @author Allou Mohamed
* @author: do not delete it
* @message if you delete or edit it you will get a global ban XD
*/
...
module.exports = {
  ...
  onStart: async function ({ message, args, event, threadsData, getLang, role, globalData }) {
    const langCode = await threadsData.get(event.threadID, "data.lang") || global.YukiBot.config.language;
    let customLang = {};
